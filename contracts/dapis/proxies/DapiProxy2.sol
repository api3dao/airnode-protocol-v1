...
import "./interfaces/IDapiProxy2.sol";
...
/// derived.
contract DapiProxy2 is IDapiProxy2 {
    ...
    function initialize(bytes32 _dapiName) external override {
        require(dapiNameHash == bytes32(0), "Already initialized");
